public class ExercicioOperadoresRelacionais {
    public static void main(String[] args) {
        ...
        System.out.println("s1 != s2 " + (s1 != s2));
        //System.out.println("s1 <= s2" + (s1 <= s2));
        //não pode comparar tamanho de grandeza entre Strings

        System.out.println("b1 == b2 " + (b1 == b2));
        System.out.println("b1 != b2 " + (b1 != b2));
        //System.out.println("b1 > b2" + (b1 > b2));
        //não tem como verificar se true é maior que false

        System.out.println("f1 > f1 " + (i1 > f1));
        System.out.println("d1 == h1 " + (d1 == h1));
        //System.out.println("s2 != c1" + (s2 != c1));
        //não tem como comparar tipos de dados muito diferentes
        //String com numerico
